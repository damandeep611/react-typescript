...
const UseStateDemo = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(
      `Username is: ${username} and the password entered is: ${password}`
    );
  };
        ...
        <div className=" w-full flex items-center justify-between p-4">
          ...
          <div className="border border-black grow">
            ...
            >
              ...
              />
              <button type="submit" className="bg-black text-white p-2 px-8">
                Login
              </button>
            </form>
          </div>
          ...
          <div className="border border-black p-8 grow text-center ">
            <button
              className="bg-black text-white p-2 px-8 cursor-pointer "
            ...
            <div>
              <button
                ...
                className="p-2 px-8 m-2 bg-black text-white cursor-pointer"
              >
                {counter}
              </button>
            </div>
