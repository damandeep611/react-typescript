...
const components: ComponentCardProps[] = [
  { icon: "=", title: "NAVBARS & MENUS", category: "Popular" },
  ...
  { icon: "⚙️", title: "FEATURES SECTIONS", category: "Popular" },
  { icon: "⋮", title: "DROPDOWN MENUS", category: "Popular" },
...
const Card = ({ icon, title }: ComponentCardProps) => {
  return (
...
const ShowcaseLibrary: React.FC = () => {
  ...
  return (
    <div className="fixed left-64 p-12">
